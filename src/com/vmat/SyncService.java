	...
	private void syncMeetingDB(){
		...
		try{
			for (int i=0; i< jsonArray.length(); ++i){
				...
				db.insert(object.getString(EventsDB.CREATED_AT), object.getString(EventsDB.DATE),
					object.getString(EventsDB.DAY), object.getString(EventsDB.DESCRIPTION),
					object.getBoolean(EventsDB.FOOD), object.getBoolean(EventsDB.SPEAKER),
					object.getString(EventsDB.SPEAKER_NAME), object.getString(EventsDB.TOPIC),
					object.getString(EventsDB.UPDATED_AT), object.getDouble(EventsDB.XCOORD),
					object.getDouble(EventsDB.YCOORD), object.getInt(EventsDB.ID));
