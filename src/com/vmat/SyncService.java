...
public class SyncService extends IntentService{
	...
	try{
		...
		twitterdb.insert(object.getString(EventsDB.CREATED_AT), 
				 object.getString(EventsDB.TEXT));
	...
	try{
		...
		// The entry does exist
		    ...
		    String localTime = mCursor.getString(mCursor.getColumnIndex(EventsDB.UPDATED_AT));
